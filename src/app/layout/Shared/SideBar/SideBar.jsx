...
const SideNavbar = ({ children }) => {
  return (
    <div>
      <aside className="w-[70px] h-screen flex flex-col items-center justify-center gap-y-6 fixed top-0 ">
        <div>
          <Link href={"/home"}>
            <svg
              ...
              viewBox="0 0 23 22"
              fill="none"
              className="w-10 h-10 bg-[#e65527] bg-opacity-20 m-2 p-1 rounded-md border-2 border-[#e65527] border-opacity-30"
            >
              <path
        ...
        <div>
          <Link href={"/#"}>
            <svg
              ...
              viewBox="0 0 22 23"
              fill="none"
              className="w-10 h-10 bg-[#101010] bg-opacity-10 m-2 p-1 rounded-md border-2 border-[#101010] border-opacity-20"
            >
              <path
